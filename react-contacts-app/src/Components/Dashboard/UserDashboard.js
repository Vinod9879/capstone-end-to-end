...
const UserDashboard = () => {
  ...
  const fetchDocumentStatus = async () => {
    try {
      ...
      console.log('No documents uploaded yet, using mock data');
  ...
  const fetchUploadHistory = async () => {
    try {
      ...
      if (Array.isArray(history)) {
        ...
        // If no history, create mock data for demonstration
        setUploadHistory([
          {
            id: 1,
            submittedAt: new Date().toISOString(),
            ecPath: '/uploads/ec.pdf',
            aadhaarPath: '/uploads/aadhaar.pdf',
            panPath: '/uploads/pan.pdf',
            isVerified: true,
            riskScore: 25,
            verificationNotes: 'All documents verified successfully',
            fieldMismatches: null
          }
        ]);
      }
    } catch (error) {
      console.log('No upload history available, using mock data');
      // Create mock data for demonstration
      setUploadHistory([
        {
          id: 1,
        ...
        },
        {
          ...
          ecPath: '/uploads/ec_old.pdf',
          aadhaarPath: '/uploads/aadhaar_old.pdf',
          panPath: '/uploads/pan_old.pdf',
          isVerified: true,
          riskScore: 45,
          verificationNotes: 'Minor discrepancies in name spelling',
          fieldMismatches: 'Name: John vs Jon'
        },
        {
          id: 3,
          submittedAt: new Date(Date.now() - 172800000).toISOString(), // 2 days ago
          ecPath: '/uploads/ec_old2.pdf',
          aadhaarPath: '/uploads/aadhaar_old2.pdf',
          panPath: '/uploads/pan_old2.pdf',
          isVerified: false,
          riskScore: 75,
          verificationNotes: 'High risk - multiple field mismatches',
          fieldMismatches: 'Name, DOB, Address mismatch'
        }
      ]);
    }
  };
